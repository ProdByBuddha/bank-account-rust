...
impl AuditEventType {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            AuditEventType::TransactionScheduled => "transaction_scheduled",
            AuditEventType::TransactionCancelled => "transaction_cancelled",
            AuditEventType::RecurringTransactionCreated => "recurring_transaction_created",
            AuditEventType::RecurringTransactionCancelled => "recurring_transaction_cancelled",
    ...
    pub fn from_str(s: &str) -> Result<Self, String> {
        match s {
            ...
            "transaction_scheduled" => Ok(AuditEventType::TransactionScheduled),
            "transaction_cancelled" => Ok(AuditEventType::TransactionCancelled),
            "recurring_transaction_created" => Ok(AuditEventType::RecurringTransactionCreated),
            "recurring_transaction_cancelled" => Ok(AuditEventType::RecurringTransactionCancelled),
